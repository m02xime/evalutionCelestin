 ...
 */
final class Version20211029115123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE restaurant ADD restaurant_id_id INT DEFAULT NULL, ADD proprietaire_id_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE restaurant DROP restaurant_id_id, DROP proprietaire_id_id');
    }
}
